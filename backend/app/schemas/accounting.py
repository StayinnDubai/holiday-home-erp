...
class BillBase(BaseModel):
    ...
    # posting_rules/bill.py.
    bank_account_id: uuid.UUID | None = None
    # VAT (doc §5.7) -- optional, drives posting_rules/tax.py's extra line(s).
    tax_code_id: uuid.UUID | None = None
    tax_amount: float = 0
    # Traceability only -- set when generated by services/rent_schedule.py.
    tenancy_contract_id: uuid.UUID | None = None
...
class BillOut(BillBase):
    ...
    contra_account_code: str | None = None
    bank_account_label: str | None = None
    tax_code_label: str | None = None
    tenancy_contract_number: str | None = None


# ---------- Invoice (accounts receivable) ----------
class InvoiceBase(BaseModel):
    customer_counterparty_id: uuid.UUID
    unit_id: uuid.UUID | None = None
    invoice_date: _date | None = None
    due_date: _date | None = None
    amount: float
    status: str = "draft"  # draft | recorded | scheduled | paid | disputed | part_paid | cancelled
    tax_code_id: uuid.UUID | None = None
    tax_amount: float = 0
    # The revenue account this invoice credits once recorded -- optional, drives
    # posting_rules/invoice.py.
    contra_account_id: uuid.UUID | None = None
    # Which bank account receives payment once 'paid' -- optional, also drives
    # posting_rules/invoice.py.
    bank_account_id: uuid.UUID | None = None
...
class InvoiceUpdate(BaseModel):
    customer_counterparty_id: uuid.UUID | None = None
    unit_id: uuid.UUID | None = None
    invoice_date: _date | None = None
    due_date: _date | None = None
    amount: float | None = None
...
# ---------- Cash transaction (Accounting > Cash Ledger) ----------

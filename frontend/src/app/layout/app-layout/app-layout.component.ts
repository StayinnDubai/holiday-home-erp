  ...
  readonly menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Bank Accounts', routerLink: '/accounting/bank-accounts' },
        { label: 'Cash Ledger', routerLink: '/accounting/cash-ledger' },
        { label: 'Invoices', routerLink: '/accounting/invoices' },
        { label: 'Bank Statement - Original', routerLink: '/accounting/bank-statement' },
        { label: 'Bank Statement - Reconciliation', routerLink: '/accounting/bank-statement-reconciliation' },
        { label: 'Counterparties', routerLink: '/accounting/counterparties' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Aged Payables', routerLink: '/reports/aged-ar-ap' },
        { label: 'Warnings', routerLink: '/reports/compliance-dashboard' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Currencies', routerLink: '/settings/currencies' },
        { label: 'Bank Account Columns', routerLink: '/settings/bank-account-columns' },
        ...
        { label: 'Online Accounts', routerLink: '/settings/online-accounts' },

...
export const INVENTORY_ITEMS_CONFIG: EntityPageConfig = {
  ...
  fields: [
    ...
    { key: 'quantity_on_hand', label: 'Qty on hand', type: 'number', showInForm: false, gridWidth: 120 },
    { key: 'weighted_average_cost', label: 'Weighted avg. cost (AED)', type: 'number', showInForm: false, gridWidth: 170 },
    { key: 'total_value', label: 'Total value (AED)', type: 'number', showInForm: false, gridWidth: 150 },

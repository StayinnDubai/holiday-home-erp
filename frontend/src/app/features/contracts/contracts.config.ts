...
export const TENANCY_CONTRACTS_CONFIG: EntityPageConfig = {
  ...
  fields: [
    ...
    { key: 'grace_period_start_date', label: 'Grace period start date', type: 'date', showInGrid: false },
    { key: 'grace_period_end_date', label: 'Grace period end date', type: 'date', showInGrid: false },
    { key: 'security_deposit_amount', label: 'Security deposit (AED)', type: 'number', showInGrid: false },
    { key: 'agency_name', label: 'Agency name', type: 'text', showInGrid: false },
    ...
    { key: 'agency_renewal_charge_amount', label: 'Agency renewal charge (AED)', type: 'number', showInGrid: false },
    { key: 'landlord_maintenance_threshold', label: 'Maintenance/repair threshold for landlord (AED)', type: 'number', showInGrid: false },
    { key: 'notice_period_days', label: 'Notice period (days)', type: 'number', showInGrid: false },
    { key: 'vacating_notice_period_days', label: 'Notice period for vacating at end (days)', type: 'number', showInGrid: false },
    { key: 'renewal_notice_period_days', label: 'Notice period for renewing at end (days)', type: 'number', showInGrid: false },
    { key: 'early_termination_notice_days', label: 'Early termination notice period (days)', type: 'number', showInGrid: false },
    { key: 'early_termination_penalty_amount', label: 'Early termination penalty (AED)', type: 'number', showInGrid: false },
    {
    ...
    // ---- Contract and addendum documents (doc §5.3 generic attachments) -- edit-view only ----
    {
      ...
      label: 'Contract & addendum documents',
      type: 'attachments-list',
      attachmentEntityType: 'tenancy_contract_document',
      showInGrid: false,
    },
  ],
};
